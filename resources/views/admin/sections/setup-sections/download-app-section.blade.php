...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#download-app-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.download-app-section.add')
    @include('admin.components.modals.site-section.download-app-section.edit')
@endsection

@push('script')

    <script>
        openModalWhenError("download-app-add","#download-app-add");
        openModalWhenError("download-app-edit","#download-app-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            $.each(languages,function(index,item) {
                ...
                editModal.find("input[name="+item.code+"_item_heading_edit]").val(oldData.language[item.code]?.item_heading);
            });
