                        ...
                        <div class="card-custom">
                            <div class="flip">
                                <div class="front bg_img" data-background="{{ get_image(@$cardApi->image ,'card-api') }}">
                                    ...
                                    <div class="end"><span class="end-text">exp. end:</span><span class="end-date"> {{ $myCard->expiry }}</span>
                                    </div>
                ...
                <div class="preview-list-wrapper">
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            <span class="text--base">{{ getAmount(@$myCard->balance,2) }} {{ get_default_currency_code() }}</span>
                        </div>
                    </div>
                    <div class="preview-list-item">
                        <div class="preview-list-left">
