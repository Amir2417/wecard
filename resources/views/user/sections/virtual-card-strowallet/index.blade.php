                ...
                <div class="swiper-slide">
                    <div class="card-wrapper d-flex justify-content-between text-center align-items-center">
                            ...
                            <div class="card-custom">
                                <div class="flip">
                                    <div class="front bg_img" data-background="{{ get_image(@$cardApi->image ,'card-api') }}">
                                        ...
                                        <div class="end"><span class="end-text">exp. end:</span><span class="end-date"> {{ date("m/Y",strtotime($myCard->expiration)) }}</span>
                                        </div>
                        ...
                        <div class="card-balance">
                            ...
                            <span class="text--base">{{ getAmount(@$myCard->balance,2) }}{{ get_default_currency_symbol() }}</span>
