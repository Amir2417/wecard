    ...
    <div class="buy-card d-flex align-items-center justify-content-between ptb-40">
        ...
        <div class="dashboard-btn-wrapper">
            <div class="dashboard-btn">
                <a href="javascript:void(0)" class="btn--base buyCard-sudo"> <i class="las la-plus"></i> {{__("Create A New Card")}}</a>
            </div>
        </div>
    </div>
                            ...
                            <div class="card-custom">
                                <div class="flip">
                                    <div class="front bg_img" data-background="{{ get_image(@$cardApi->image ,'card-api') }}">
                                        ...
                                        <div class="end"><span class="end-text">exp. end: </span><span class="end-date"> {{$myCard->expiryMonth }} / {{$myCard->expiryYear }}</span>
                                        </div>
                        ...
                        <div class="card-balance">
                            ...
                            <div class="card-content d-flex justify-content-center mt-3">
                                <div class="card-details">
                                    <a href="{{ setRoute('user.sudo.virtual.card.details',$myCard->card_id) }}">
