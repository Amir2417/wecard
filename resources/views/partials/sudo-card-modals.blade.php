                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form--control card_amount" required placeholder="{{ __("Enter Amount") }}" name="card_amount" value="{{ old("card_amount") }}">
                                    <div class="currency">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form class="card-form row g-4" action="{{ setRoute('user.sudo.virtual.card.fund.confirm') }}" method="POST">
                        @csrf
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <input type="number" class="form--control fundAmount" required placeholder="{{ __("Enter Amount") }}" name="fund_amount" value="{{ old("fund_amount") }}">
                                <div class="currency">
                                    <p>{{ get_default_currency_code() }}</p>
                                </div>
                               <div class="d-flex justify-content-between">
...
@push('script')
    <script>
        ...
        $('.fundCardSudo').on('click', function () {
            ...
            function feesCalculation() {
                var currencyCode = acceptVar().currencyCode;
                var currencyRate = acceptVar().currencyRate;
                var sender_amount = $(".fundAmount").val();
                sender_amount == "" ? (sender_amount = 0) : (sender_amount = sender_amount);
            ...
            function getPreview() {
                    ...
                    var senderAmount = $(".fundAmount").val();
                    var charges = feesCalculation();
                    var sender_currency = acceptVar().currencyCode;
                    var sender_currency_rate = acceptVar().currencyRate;
            ...
            function enterLimit(){
                ...
                var currencyRate = acceptVar().currencyRate;
                var sender_amount = parseFloat($(".fundAmount").val());
