...
function stro_wallet_create_user($user,$formData,$public_key,$base_url){
    ...
    $response               = $client->request('POST', $base_url.'create-user/', [
        ...
        'form_params'       => [
            ...
            'idImage'       => 'https://akash.appdevs.net/adcrypto/public/frontend/images/site-section/seeder/download-app.webp',
            'userPhoto'     => 'https://akash.appdevs.net/adcrypto/public/frontend/images/site-section/seeder/download-app.webp',
