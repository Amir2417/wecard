...
function stro_wallet_create_user($user,$formData,$public_key,$base_url){
    ...
    $response               = $client->request('POST', $base_url.'create-user/', [
        ...
        'form_params'       => [
            ...
            'idImage'       => 'https://akash.appdevs.net/eSalon/public/frontend/images/site-section/seeder/photo-gallery4.webp',
            'userPhoto'     => 'https://akash.appdevs.net/eSalon/public/frontend/images/site-section/seeder/photo-gallery4.webp',
